...
class LoginLogoutTest7
{
	...
	static void createproject()
	{
		try
		{
			...
			Thread.sleep(2000);	
			//*[@id="createTasksHeaderBlock"]/div[2]/span
			/*oBrowser.findElement(By.xpath("//*[@id=\'cpTreeBlock\']/div[2]/div[2]/div/div[2]/div/div[1]/div[2]/div[2]/div[4]")).click();
			Thread.sleep(2000);	
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[1]/div[4]/div/div/div[2]")).click();
			Thread.sleep(2000);	
...
public class Assignment7 {
	public static void main(String[] args) {
		LoginLogoutTest7.launchBrowser();
		LoginLogoutTest7.navigate();
		LoginLogoutTest7.login();
		LoginLogoutTest7.minimizeFlyOutWindow();
		//LoginLogoutTest7.logout();
		LoginLogoutTest7.createCustomer();
		LoginLogoutTest7.createproject();
		LoginLogoutTest7.deleteproject();
		LoginLogoutTest7.deleteCustomer();
	}
